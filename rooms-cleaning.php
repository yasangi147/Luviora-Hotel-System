...
$data = [];
try {
    $data = $db->query("SELECT * FROM rooms WHERE status = 'cleaning' ORDER BY room_number ASC")->fetchAll();
        ...
        <div class="content-wrapper">
            ...
            <div class="data-table-card">
                <div class="table-header">
                    <h3><i class="fas fa-broom"></i> Cleaning Status</h3>
                </div>
