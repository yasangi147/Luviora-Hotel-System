...
$data = [];
try {
    $data = $db->query("SELECT b.*, u.name as guest_name FROM bookings b JOIN users u ON b.user_id = u.user_id WHERE b.payment_status = 'paid' ORDER BY b.created_at DESC")->fetchAll();
