...
$db = getDB();
$items = $db->query("SELECT * FROM users ORDER BY created_at DESC LIMIT 100")->fetchAll();
?>
<!DOCTYPE html>
<html><head><meta charset="UTF-8"><title>Staff Performance | Luviora Admin</title>
...
<div class="page-header"><h1><i class="fas fa-chart-line"></i> Staff Performance</h1>
<a href="staff.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a></div>
<div class="data-table-card"><div class="table-header"><h3>All Records (<?php echo count($items); ?>)</h3></div>
<div class="table-responsive"><table class="table">
<thead><tr><th>Staff</th><th>Role</th><th>Performance</th></tr></thead>
<tbody>
<?php if (empty($items)): ?>
