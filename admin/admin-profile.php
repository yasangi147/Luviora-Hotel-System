<?php
/**
 * Admin Profile Page - Luviora Hotel System
 * Allows admin to view and edit their profile details
 */
...
$db = getDB();
$adminId = $_SESSION['admin_id'] ?? 1; // Default to admin user ID 1
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email)) {
        ...
        try {
            ...
            $stmt->execute([$name, $email, $phone, $address, $city, $country, $postal_code, $adminId]);
...
<head>
    ...
    <title>Admin Profile - Luviora Hotel System</title>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="city" value="<?php echo htmlspecialchars($admin['city'] ?? ''); ?>">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Country</label>
                                    <input type="text" class="form-control" name="country" value="<?php echo htmlspecialchars($admin['country'] ?? ''); ?>">
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label class="form-label">Postal Code</label>
                                    <input type="text" class="form-control" name="postal_code" value="<?php echo htmlspecialchars($admin['postal_code'] ?? ''); ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo date('M d, Y H:i', strtotime($admin['updated_at'])); ?>" disabled>
                                </div>
                            </div>
                        </div>
