...
$data = [];
try {
    $data = $db->query("SELECT b.*, u.name as guest_name, r.room_number, r.room_name FROM bookings b JOIN users u ON b.user_id = u.user_id JOIN rooms r ON b.room_id = r.room_id WHERE b.booking_status = 'cancelled' ORDER BY b.updated_at DESC")->fetchAll();
